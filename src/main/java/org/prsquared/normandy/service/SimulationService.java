...
public class SimulationService {
    ...
    public List<Team> populateTeams() {
        ...
        teamList.add(new Team("Chelsea", 82,77, AttackStyle.COUNTER_ATTACK, DefenceStyle.LOW_BLOCK));
        teamList.add(new Team("Aston Villa", 75,76, AttackStyle.COUNTER_ATTACK, DefenceStyle.LOW_BLOCK));
        teamList.add(new Team("Manchester United", 82,84, AttackStyle.COUNTER_ATTACK, DefenceStyle.LOW_BLOCK));
