...
public class SimulationService {
    ...
    public List<Team> populateTeams() {
        ...
        teamList.add(new Team("Arsenal", 80,76, AttackStyle.POSSESSION, DefenceStyle.NEUTRAL));
        teamList.add(new Team("Manchester City", 86,86, AttackStyle.POSSESSION, DefenceStyle.HIGH_PRESS));
        teamList.add(new Team("Leeds United", 78,70, AttackStyle.COUNTER_ATTACK, DefenceStyle.HIGH_PRESS));
        teamList.add(new Team("Tottenham", 82,82, AttackStyle.COUNTER_ATTACK, DefenceStyle.HIGH_PRESS));
        teamList.add(new Team("Brighton", 78,78, AttackStyle.POSSESSION, DefenceStyle.NEUTRAL));
        ...
        teamList.add(new Team("Brentford", 78,76, AttackStyle.COUNTER_ATTACK, DefenceStyle.HIGH_PRESS));
        ...
        teamList.add(new Team("Chelsea", 82,77, AttackStyle.POSSESSION, DefenceStyle.NEUTRAL));
        teamList.add(new Team("Aston Villa", 75,76, AttackStyle.COUNTER_ATTACK, DefenceStyle.LOW_BLOCK));
        teamList.add(new Team("Manchester United", 82,84, AttackStyle.POSSESSION, DefenceStyle.HIGH_PRESS));
        teamList.add(new Team("Bournemouth", 75,75, AttackStyle.COUNTER_ATTACK, DefenceStyle.LOW_BLOCK));
        teamList.add(new Team("Liverpool", 85,85, AttackStyle.POSSESSION, DefenceStyle.HIGH_PRESS));
        ...
        teamList.add(new Team("Leicester City", 80,80, AttackStyle.COUNTER_ATTACK, DefenceStyle.LOW_BLOCK));
